...
export default function CommunitySection({ language }: CommunitySectionProps) {
  ...
  const pickText = (values: Record<Language, string>) => values[currentLanguage]
        ...
        >
          ...
          <p className="text-lg" style={{ color: '#848E9C' }}>
            {pickText({
              ...
              de: 'Sieh dir an, was andere sagen',
              id: 'See what others are saying',
            })}
          </p>
        </motion.div>

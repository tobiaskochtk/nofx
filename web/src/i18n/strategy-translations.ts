...
export const indicator = {
  ...
  signalFeatures: { zh: 'Signalgeber F-Signale', en: 'Signal F-Blocks', es: 'Bloques F de Señal' },
  signalFeaturesDesc: { zh: '可切换的微观结构信号块，默认沿用当前策略的有效信号覆盖', en: 'Toggleable microstructure signal blocks; defaults preserve the current strategy signal coverage', es: 'Bloques de microestructura configurables; preservan la cobertura actual por defecto' },
  f4: { zh: 'F4 订单流', en: 'F4 Orderflow', es: 'F4 Flujo de Órdenes' },
  f4Desc: { zh: 'CVD、盘口失衡、主动买入占比等短线订单流信号', en: 'Short-term orderflow signals such as CVD, imbalance and taker-buy ratio', es: 'Señales cortas de flujo como CVD, imbalance y taker-buy ratio' },
  f5: { zh: 'F5 风险地图', en: 'F5 Risk Map', es: 'F5 Mapa de Riesgo' },
  f5Desc: { zh: '清算风险、ATR 距离和偏好方向等风险结构信号', en: 'Risk-structure signals such as liquidation pressure, ATR distance and preferred direction', es: 'Señales de riesgo como presión de liquidación, distancia ATR y dirección preferida' },
  f6: { zh: 'F6 结构位', en: 'F6 Levels', es: 'F6 Niveles' },
  f6Desc: { zh: 'AVWAP 邻近结构位、回收/拒绝与方向偏置', en: 'AVWAP nearby levels, reclaim/rejection behaviour and structural bias', es: 'Niveles AVWAP, comportamiento de reclaim/rejection y sesgo estructural' },
  f7: { zh: 'F7 波动结构', en: 'F7 Volatility', es: 'F7 Volatilidad' },
  f7Desc: { zh: 'BBW、挤压、释放与波动状态', en: 'BBW, squeeze, release and volatility regime context', es: 'BBW, squeeze, liberación y régimen de volatilidad' },
  nofxosTitle: { zh: '信号数据提供方', en: 'Signal Data Provider', es: 'Proveedor de Señales' },
  nofxosDesc: { zh: 'AI500 兼容的市场信号服务', en: 'AI500-compatible market signal service', es: 'Servicio de señales compatible con AI500' },
  ...
  providerMode: { zh: '提供方模式', en: 'Provider Mode', es: 'Modo del Proveedor' },
  providerOfficial: { zh: '官方 NOFXOS', en: 'Official NOFXOS', es: 'NOFXOS Oficial' },
  providerSelfhosted: { zh: 'Selfhosted AI500', en: 'Selfhosted AI500', es: 'AI500 Selfhosted' },
  providerUrl: { zh: '服务地址', en: 'Service URL', es: 'URL del Servicio' },
  providerUrlPlaceholder: { zh: '输入自托管服务 Base URL，例如 https://ai500.local', en: 'Enter selfhosted service base URL, e.g. https://ai500.local', es: 'Ingrese la URL base selfhosted, ej. https://ai500.local' },
  providerToken: { zh: '访问令牌', en: 'Access Token', es: 'Token de Acceso' },
  providerTokenPlaceholder: { zh: '输入提供方 API Token', en: 'Enter provider API token', es: 'Ingrese el token API del proveedor' },
  officialHint: { zh: '官方模式可继续通过 claw402 路由到 NOFXOS 数据服务。', en: 'Official mode can continue routing NOFXOS data through claw402.', es: 'El modo oficial puede seguir usando claw402 para NOFXOS.' },
  selfhostedHint: { zh: 'Selfhosted 模式会直接请求你自己的 AI500 兼容服务，不走 claw402。', en: 'Selfhosted mode calls your own AI500-compatible service directly and bypasses claw402.', es: 'El modo selfhosted llama tu servicio AI500 directamente y evita claw402.' },
  apiKey: { zh: 'API Key', en: 'API Key', es: 'API Key' },
  apiKeyPlaceholder: { zh: '输入提供方 API Token', en: 'Enter provider API token', es: 'Ingresar token API' },
  ...
  nofxosDataSources: { zh: '提供方驱动的数据源', en: 'Provider-backed Data Sources', es: 'Fuentes Respaldadas por el Proveedor' },
  configureApiKey: { zh: '请配置提供方信息以启用 AI500 兼容数据源', en: 'Please configure the provider to enable AI500-compatible data sources', es: 'Configure el proveedor para habilitar fuentes AI500' },
};

...
export const translations = {
  en: {
    ...
    traderConfigModal: {
      ...
      createTitle: 'Create Trader',
      editSubtitle: 'Update trader configuration parameters',
      createSubtitle: 'Configure a new AI trader',
      ...
      fetchedBalanceSuccess: 'Current balance fetched',
      manualBalanceHint:
        'Use to manually update the initial balance baseline (after deposit/withdrawal)',
      fetchBalanceEditOnly: 'You can only fetch current balance in edit mode',
      fetchBalanceFailed: 'Failed to fetch balance, please check your network connection',
      autoInitialBalanceHint:
        'System will automatically fetch your account equity as the initial balance',
      tradingSymbolsLabel:
        'Trading Symbols (comma separated, leave empty to use default)',
      quickSelect: 'Quick Select',
      hideQuickSelect: 'Hide Selector',
      tapToSelect: 'Tap to select coins:',
      signalSourceTitle: 'Signal Source Configuration',
      useCoinPoolSignal: 'Use Coin Pool signal',
      useOiTopSignal: 'Use OI Top signal',
      promptTitle: 'Trading Strategy Prompt',
      promptTemplateHint:
        'Choose a preset trading strategy template (includes philosophy and risk controls)',
      overrideDefaultPrompt: 'Override default prompt',
      overridePromptWarning: 'When enabled, the default strategy will be fully replaced',
      customPromptLabel: 'Custom Prompt',
      additionalPromptLabel: 'Additional Prompt',
      customPromptPlaceholder: 'Enter full trading strategy prompt...',
      additionalPromptPlaceholder: 'Enter extra trading strategy notes...',
  ...
  zh: {
    ...
    traderConfigModal: {
      editTitle: '修改交易员',
      createTitle: '创建交易员',
      editSubtitle: '修改交易员配置参数',
      createSubtitle: '配置新的AI交易员',
      basicConfig: '基础配置',
      tradingConfig: '交易配置',
      marginMode: '保证金模式',
      ...
      fetchingBalance: '获取中...',
      fetchedBalanceSuccess: '已获取当前余额',
      manualBalanceHint: '用于手动更新初始余额基准（例如充值/提现后）',
      fetchBalanceEditOnly: '只有在编辑模式下才能获取当前余额',
      fetchBalanceFailed: '获取余额失败，请检查网络连接',
      autoInitialBalanceHint: '系统将自动获取您的账户净值作为初始余额',
      tradingSymbolsLabel: '交易币种（逗号分隔，留空使用默认）',
      quickSelect: '快速选择',
      hideQuickSelect: '收起选择',
      tapToSelect: '点击选择币种：',
      signalSourceTitle: '信号源配置',
      useCoinPoolSignal: '使用 Coin Pool 信号',
      useOiTopSignal: '使用 OI Top 信号',
      promptTitle: '交易策略提示词',
      promptTemplateHint: '选择预设的交易策略模板（包含交易哲学、风控原则等）',
      overrideDefaultPrompt: '覆盖默认提示词',
      overridePromptWarning: '启用后将完全替换默认策略',
